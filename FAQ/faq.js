function toggleAnswer(id) {
    ...
    const arrowElement = document.querySelector(`[onclick="toggleAnswer(${id})"] .arrow`);
...
window.onload=window.onresize=()=>{
    ...
    document.getElementById('header-text-bg').style.height=parseFloat(window.getComputedStyle(document.getElementById('header-text')).fontSize)/1.5+'px';
}
