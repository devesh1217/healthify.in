...
function showCategory(category) {
  ...
  // const selectedutton = document.querySelector(`button[data-category="${category}"]`);
  // selectedutton.style.backgroundColor = "pink";
  // let selectedutton = document.querySelector("#lunch");
  // selectedutton.addEventListener('click',()=>selectedutton.style.backgroundColor='pink');
